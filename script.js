...
function transformSelection(style) {
    ...
    newRange.setEnd(textNode, transformed.length);
...
function addEmoji(char) {
    composer.focus(); // Asegurar que el foco esté en el editor
    const selection = window.getSelection();
    ...
    if (selection.rangeCount > 0) {
        ...
        // Si por alguna razón no hay rango, añadir al final
